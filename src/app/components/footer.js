  ...
  social: [
    {
      ...
      href: '#',
      icon: (props) => (
        <svg fill="currentColor" width="26" height="26" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      href: '#',
      icon: (props) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="26" height="26" viewBox="0 0 50 50" {...props}>
          <path
            fillRule="evenodd" 
...
export default function Footer() {
  return (
    <footer className="bg-white" aria-labelledby="footer-heading" style={{fontFamily:'GeistSans, sans-serif'}}>
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-bold text-blue-700 tracking-wider uppercase">Solutions</h3>
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-base text-gray-800 hover:text-gray-500">
                        {item.name}
                      </a>
                    </li>
                  ))}
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-bold text-blue-700 tracking-wider uppercase">Support</h3>
                <ul role="list" className="mt-4 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-bold text-blue-700 tracking-wider uppercase">Company</h3>
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.company.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-base text-gray-800 hover:text-gray-600">
                        {item.name}
                      </a>
                    </li>
                  ))}
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            {navigation.social.map((item) => (
              <a key={item.name} href={item.href} className="text-gray-800 hover:text-gray-600">
