                        ...
                        <li class="">
                          ...
                          >
                            ...
                            <div class="ml-4 w-4/5">
                              <h5 class="text-gray-900 text-base mb-1.5 font-semibold">
                                Analytics
                                <span class="bg-indigo-50 text-indigo-500 text-xs font-medium mr-2 px-2.5 py-1 rounded-full h-5 ml-4">
                                  New
                                </span>
                              </h5>
                              <p class="text-xs font-medium text-gray-400">
  ...
  <div class="relative pb-5">
    ...
    <main class="mt-28 mx-auto max-w-12xl px-4">
      <div class="text-center space-y-2">
        <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-5xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block">
          <span className="absolute inset-0 overflow-hidden rounded-full">
            <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
          </span>
          <div className="relative flex space-x-2 items-center z-4 rounded-full bg-white py-1 px-3 ring-1 ring-white/5 hover:ring-indigo-700  transition duration-300">
            <span className=" text-black">✨ Introducing SiteGenie</span>
        ...
        <p class="max-w-md mx-auto py-1 text-gray-700 text-lg md:max-w-3xl">
          Transform your website experience with our tailored chatbot. Expertly
          trained for efficiency, it saves you time and delivers unmatched
          interaction.
        </p>
        <div className="flex items-center justify-center py-4">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px  text-white inline-block">
            <span className="absolute inset-0 overflow-hidden rounded-full">
              <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
            </span>
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-indigo-600 py-2 px-4 ring-1 ring-white/5 hover:ring-indigo-700  transition duration-300">
