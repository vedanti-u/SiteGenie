...
const features = [
  {
    title: "Easy Payment",
    description:
      "We Provide Various Methods For You To Carry Out All Tran",
    icon: (
      <svg
        width="30"
        height="30"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 lg:mb-16 flex justify-center items-center flex-col gap-x-0 gap-y-6 lg:gap-y-0 lg:flex-row lg:justify-between max-md:max-w-lg max-md:mx-auto">
          <div className="relative w-full text-center lg:text-left lg:w-2/4">
            <h2 className="text-5xl text-gray-900 leading-[3.25rem] lg:mb-6 mx-auto max-w-max lg:max-w-md lg:mx-0">
              Features of
            </h2>
            <h2 className="text-5xl text-indigo-600 leading-[3.25rem] lg:mb-6 mx-auto max-w-max lg:max-w-md lg:mx-0">
              SiteGenie.ai
            </h2>
          </div>
          <div className="relative w-full text-center lg:text-left lg:w-2/4">
            <p className="text-lg font-normal text-gray-600 mb-5">
              Enjoy the finest features with our products.We provide all the
              advantages that can simplify all your financial transactions
        ...
        <div className="flex justify-center items-center gap-x-5 gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3 capitalize transition-all duration-500 group-hover:text-white">
                {feature.title}
              </h4>
              <p className="text-lg font-normal text-gray-500 transition-all duration-500 leading-5 group-hover:text-white">
                {feature.description}
              </p>
            </div>
          ))}
